...
//				g2.setColor(shape.getColor());
//				if (shape instanceof Rectangle) {
//					g2.fillRect(shape.getX() - (camera.getX() - dimension.width / 2), shape.getY(), shape.getWidth(),
//							shape.getHeight());
//				} else {
//					g2.fillOval(shape.getX() - (camera.getX() - dimension.width / 2), shape.getY(), shape.getWidth(),
//							shape.getHeight());
//				}
//			}
//
...
//					if (gameObjects.get(i) instanceof IChangeableColor) {
//						BufferedImage bufImage = (BufferedImage) imageObjects.get(i);
//						g2.drawImage(((IChangeableColor) gameObjects.get(i)).getBufferedImage(),
//								gameObjects.get(i).getX() - (camera.getX() - dimension.width / 2), gameObjects.get(i).getY(), gameObjects.get(i).getWidth(),
//								gameObjects.get(i).getHeight(), null);
//
//					} else {
//						g2.drawImage(imageObjects.get(i), gameObjects.get(i).getX() - (camera.getX() - dimension.width / 2), gameObjects.get(i).getY(),
//								gameObjects.get(i).getWidth(), gameObjects.get(i).getHeight(), null);
//
//					}
//				}
...
//		setSize(dimension);
		camera = new Camera(dimension.width / 2, dimension.height / 2);
